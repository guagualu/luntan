...
func Userdenglugetclient(param model.User, c *gin.Context) (*userpb.Userdenglugetresponse, error) {
	...
	// 调用服务
	rsp, err := client.Dengluget(c, &userpb.Userdenglugetrequest{ //客户端调用
		Name:     param.Name,
		Id:       int64(param.ID),
