...
func Guanzhulistclient(param model.Guanzhu, page int, c *gin.Context) (*guanzhupb.Guanzhulistresponse, error) {
	...
	// 调用服务
	rsp, err := client.List(c, &guanzhupb.Guanzhulistrequest{ //客户端调用
		Uid:  int64(param.Uid),
		Page: int64(page),
	})
	return rsp, err
