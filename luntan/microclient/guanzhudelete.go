...
func Guanzhudeleteclient(param model.Guanzhu, c *gin.Context) (*guanzhupb.Guanzhudeleteresponse, error) {
	...
	// 调用服务
	rsp, err := client.Delete(c, &guanzhupb.Guanzhudeletrequest{ //客户端调用
		Uid:      int64(param.Uid),
