...
func Userpaihangclient(param model.User, page int, c *gin.Context) (*userpb.Userpaihangresponse, error) {
	...
	// 调用服务
	rsp, err := client.Paihang(c, &userpb.Userpaihangrequest{ //客户端调用
		Page: int64(page),
	})
	return rsp, err
}
