...
func Dianzandeleteclient(param model.Dianzan, c *gin.Context) (*dianzanpb.Dianzandeleteresponse, error) {
	...
	// 调用服务
	rsp, err := client.Delete(c, &dianzanpb.Dianzandeletrequest{ //客户端调用
		Id: int64(param.ID),
	})
	return rsp, err
}
